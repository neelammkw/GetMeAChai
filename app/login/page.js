...
const Login = () => {
  ...
  return (
    <div className="text-white container mx-auto py-14">
      ...
      <div className="flex flex-col gap-2 min-h-screen items-center p-10 w-100">
        <button className="flex w-80 items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
          <svg
